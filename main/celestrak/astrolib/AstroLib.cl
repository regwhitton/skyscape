...
//	void gstime00
//	(
//		double jdut1, double deltapsi, double ttt, const iau06data &iau06arr, double fArgs[14], double& gst,
...
//		for (i = 32; i >= 0; i--)
//		{
//			tempval = iau06arr.agsti[i][0] * fArgs[0] + iau06arr.agsti[i][1] * fArgs[1] + iau06arr.agsti[i][2] * fArgs[2] 
//				+ iau06arr.agsti[i][3] * fArgs[3] + iau06arr.agsti[i][4] * fArgs[4] + iau06arr.agsti[i][5] * fArgs[5]
//				+ iau06arr.agsti[i][6] * fArgs[6] + iau06arr.agsti[i][7] * fArgs[7] + iau06arr.agsti[i][8] * fArgs[8] 
//				+ iau06arr.agsti[i][9] * fArgs[9] + iau06arr.agsti[i][10] * fArgs[10] + iau06arr.agsti[i][11] * fArgs[11] 
//				+ iau06arr.agsti[i][12] * fArgs[12] + iau06arr.agsti[i][13] * fArgs[13];
//			gstsum0 = gstsum0 + iau06arr.agst[i][0] * sin(tempval) + iau06arr.agst[i][1] * cos(tempval);
//		}
//
//		gstsum1 = 0.0;
//		// data file is not reversed
...
//				+ iau06arr.agsti[i][9] * fArgs[9] + iau06arr.agsti[i][10] * fArgs[10] + iau06arr.agsti[i][11] * fArgs[11] 
//				+ iau06arr.agsti[i][12] * fArgs[12] + iau06arr.agsti[i][13] * fArgs[13];
//			gstsum1 = gstsum1 + (iau06arr.agst[i][0] * sin(tempval) + iau06arr.agst[i][1] * cos(tempval)) * ttt;
//		}
//
...
//         *    opt         - method option                                e06cio, e00a, e96, e80
//         *
//         *  outputs       :
...
//		deg2rad = pi / 180.0;
//		oo3600 = 1.0 / 3600.0;
//        fArgs[0] = fArgs[1] = fArgs[2] = fArgs[3] = fArgs[4] = fArgs[5] = fArgs[6] = fArgs[7] = fArgs[8] = fArgs[9] = fArgs[10] = fArgs[11] = fArgs[12] = fArgs[13] = 0.0;
//
//        // ---- determine coefficients for various iers nutation theories ----
//     	// ----  iau-2010 cio theory and iau-2000a theory
//				if (opt == e06cio || opt == e06a)
//				{
//					// ------ form the delaunay fundamental arguments in ", converted to rad
//					fArgs[0] = ((((-0.00024470 * ttt + 0.051635) * ttt + 31.8792) * ttt + 1717915923.2178) * ttt
//						+ 485868.249036) * oo3600;
//					fArgs[1] = ((((-0.00001149 * ttt + 0.000136) * ttt - 0.5532) * ttt + 129596581.0481) * ttt
//						+ 1287104.793048) * oo3600;
//					fArgs[2] = ((((+0.00000417 * ttt - 0.001037) * ttt - 12.7512) * ttt + 1739527262.8478) * ttt
//						+ 335779.526232) * oo3600;
//					fArgs[3] = ((((-0.00003169 * ttt + 0.006593) * ttt - 6.3706) * ttt + 1602961601.2090) * ttt
//						+ 1072260.703692) * oo3600;
//					fArgs[4] = ((((-0.00005939 * ttt + 0.007702) * ttt + 7.4722) * ttt - 6962890.5431) * ttt
//						+ 450160.398036) * oo3600;
//
//					// ------ form the planetary arguments in ", converted to deg
//					//fArgs[5] = (908103.259872 + 538101628.688982 * ttt) * oo3600;
//					//fArgs[6] = (655127.283060 + 210664136.433548 * ttt) * oo3600;
//					//fArgs[7] = (361679.244588 + 129597742.283429 * ttt) * oo3600;
//					//fArgs[8] = (1279558.798488 + 68905077.493988 * ttt) * oo3600;
//					//fArgs[9] = (123665.467464 + 10925660.377991 * ttt) * oo3600;
//					//fArgs[10] = (180278.799480 + 4399609.855732 * ttt) * oo3600;
//					//fArgs[11] = (1130598.018396 + 1542481.193933 * ttt) * oo3600;
//					//fArgs[12] = (1095655.195728 + 786550.320744 * ttt) * oo3600;
//					//fArgs[13] = ((1.112022 * ttt + 5028.8200) * ttt) * oo3600;
//					// these are close (all in rad) - usually 1e-10, but some are as high as 1e-06
//					fArgs[5] = fmod(4.402608842 + 2608.7903141574 * ttt , twopi);
//					fArgs[6] = fmod(3.176146697 + 1021.3285546211 * ttt , twopi);
//					fArgs[7] = fmod(1.753470314 + 628.3075849991 * ttt , twopi);
//					fArgs[8] = fmod(6.203480913 + 334.0612426700 * ttt , twopi);
//					fArgs[9] = fmod(0.599546497 + 52.9690962641 * ttt , twopi);
//					fArgs[10] = fmod(0.874016757 + 21.3299104960 * ttt , twopi);
//					fArgs[11] = fmod(5.481293872 + 7.4781598567 * ttt , twopi);
//					fArgs[12] = fmod(5.311886287 + 3.8133035638 * ttt , twopi);
//					fArgs[13] = (0.024381750 + 0.00000538691 * ttt ) *ttt;
//				}
//
//		// ---- iau-1996 theory
//		if (opt == e96)
...
//			fArgs[0] = ((((-0.00024470 * ttt + 0.051635) * ttt + 31.8792) * ttt + 1717915923.2178) * ttt) * oo3600 
//				+ 134.96340251;
//			fArgs[1] = ((((-0.00001149 * ttt - 0.000136) * ttt - 0.5532) * ttt + 129596581.0481) * ttt) * oo3600 
//				+ 357.52910918;
//			fArgs[2] = ((((+0.00000417 * ttt + 0.001037) * ttt - 12.7512) * ttt + 1739527262.8478) * ttt) * oo3600 
//				+ 93.27209062;
//			fArgs[3] = ((((-0.00003169 * ttt + 0.006593) * ttt - 6.3706) * ttt + 1602961601.2090) * ttt) * oo3600 
//				+ 297.85019547;
//			fArgs[4] = ((((-0.00005939 * ttt + 0.007702) * ttt + 7.4722) * ttt - 6962890.2665) * ttt) * oo3600 
//				+ 125.04455501;
//			// ------ form the planetary arguments in deg
//			fArgs[5] = 0.0;
//			fArgs[6] = 181.979800853 + 58517.8156748   * ttt;
//			fArgs[7] = 100.466448494 + 35999.3728521   * ttt;
//			fArgs[8] = 355.433274605 + 19140.299314    * ttt;
//			fArgs[9] = 34.351483900 + 3034.90567464  * ttt;
//			fArgs[10] = 50.0774713998 + 1222.11379404  * ttt;
//			fArgs[11] = 0.0;
//			fArgs[12] = 0.0;
//			fArgs[13] = (0.0003086 * ttt + 1.39697137214) * ttt;
//		}
//
//		// ---- iau-1980 theory
//		if (opt == e80)
//		{
//			// ------ form the delaunay fundamental arguments in deg
//			fArgs[0] = ((((0.064) * ttt + 31.310) * ttt + 1717915922.6330) * ttt) * oo3600 
//				+ 134.96298139;
//			fArgs[1] = ((((-0.012) * ttt - 0.577) * ttt + 129596581.2240) * ttt) * oo3600 
//				+ 357.52772333;
//			fArgs[2] = ((((0.011) * ttt - 13.257) * ttt + 1739527263.1370) * ttt) * oo3600 
//				+ 93.27191028;
//			fArgs[3] = ((((0.019) * ttt - 6.891) * ttt + 1602961601.3280) * ttt) * oo3600 
//				+ 297.85036306;
//			fArgs[4] = ((((0.008) * ttt + 7.455) * ttt - 6962890.5390) * ttt) * oo3600 
//				+ 125.04452222;
//			// ------ form the planetary arguments in deg
//			// iers tn13 shows no planetary
//			// seidelmann shows these equations
//			// circ 163 shows no planetary ???????
//			fArgs[5] = 252.3 + 149472.0  * ttt;
//			fArgs[6] = 179.9 + 58517.8  * ttt;
//			fArgs[7] = 98.4 + 35999.4  * ttt;
//			fArgs[8] = 353.3 + 19140.3  * ttt;
//			fArgs[9] = 32.3 + 3034.9  * ttt;
//			fArgs[10] = 48.0 + 1222.1  * ttt;
//			fArgs[11] = 0.0;
//			fArgs[12] = 0.0;
//			fArgs[13] = 0.0;
//		}
...
//		{
//			// ------ form the delaunay fundamental arguments in deg
//			fArgs[0] = (1717915923.2178 * ttt + 485868.249036) * oo3600;
//			fArgs[1] = (129596581.0481 * ttt + 1287104.79305) * oo3600;
//			fArgs[2] = (1739527262.8478 * ttt + 335779.526232) * oo3600;
//			fArgs[3] = (1602961601.2090 * ttt + 1072260.70369) * oo3600;
//			fArgs[4] = (-6962890.5431 * ttt + 450160.398036) * oo3600;
//
//			// ------ form the planetary arguments in deg
//			fArgs[5] = 0.0;
//			fArgs[6] = 0.0;
...
//		fArgs[0] = fmod(fArgs[0], 360.0)      *  deg2rad;
//		fArgs[1] = fmod(fArgs[1], 360.0)     *  deg2rad;
//		fArgs[2] = fmod(fArgs[2], 360.0)      *  deg2rad;
//		fArgs[3] = fmod(fArgs[3], 360.0)      *  deg2rad;
//		fArgs[4] = fmod(fArgs[4], 360.0)  *  deg2rad;
//
//		fArgs[5] = fmod(fArgs[5], 360.0) * deg2rad;
//		fArgs[6] = fmod(fArgs[6], 360.0) * deg2rad;
//		fArgs[7] = fmod(fArgs[7], 360.0) * deg2rad;
//		fArgs[8] = fmod(fArgs[8], 360.0) * deg2rad;
//		fArgs[9] = fmod(fArgs[9], 360.0) * deg2rad;
//		fArgs[10] = fmod(fArgs[10], 360.0) * deg2rad;
//		fArgs[11] = fmod(fArgs[11], 360.0) * deg2rad;
//		fArgs[12] = fmod(fArgs[12], 360.0) * deg2rad;
//		fArgs[13] = fmod(fArgs[13], 360.0) * deg2rad;
//
//		if (iauhelp == 'y')
//		{
//			printf("fa %11.7f  %11.7f  %11.7f  %11.7f  %11.7f deg \n", fArgs[0] * 180 / pi, fArgs[1] * 180 / pi, fArgs[2] * 180 / pi, fArgs[3] * 180 / pi, fArgs[4] * 180 / pi);
//			printf("fa %11.7f  %11.7f  %11.7f  %11.7f deg \n", fArgs[5] * 180 / pi, fArgs[6] * 180 / pi, fArgs[7] * 180 / pi, fArgs[8] * 180 / pi);
//			printf("fa %11.7f  %11.7f  %11.7f  %11.7f deg \n", fArgs[9] * 180 / pi, fArgs[10] * 180 / pi, fArgs[11] * 180 / pi, fArgs[12] * 180 / pi);
//			printf("fa %11.7f  \n", fArgs[13] * 180 / pi);
//		}
//	}  // procedure fundarg
//
...
//		for (i = 1305; i >= 0; i--)
//		{
//			tempval = iau06arr.a0xi[i][0] * fArgs[0] + iau06arr.a0xi[i][1] * fArgs[1] + iau06arr.a0xi[i][2] * fArgs[2] 
//				+ iau06arr.a0xi[i][3] * fArgs[3] + iau06arr.a0xi[i][4] * fArgs[4] 
//				+ iau06arr.a0xi[i][5] * fArgs[5] + iau06arr.a0xi[i][6] * fArgs[6] + iau06arr.a0xi[i][7] * fArgs[7] + iau06arr.a0xi[i][8] * fArgs[8] 
//				+ iau06arr.a0xi[i][9] * fArgs[9] + iau06arr.a0xi[i][10] * fArgs[10] + iau06arr.a0xi[i][11] * fArgs[11] + iau06arr.a0xi[i][12] * fArgs[12] 
//				+ iau06arr.a0xi[i][13] * fArgs[13];
//			sum0 = sum0 + iau06arr.axs0[i][0] * sin(tempval) + iau06arr.axs0[i][1] * cos(tempval);
//		}
//		sum1 = 0.0;
...
//		{
//			i = 1306 + j;
//			tempval = iau06arr.a0xi[i][0] * fArgs[0] + iau06arr.a0xi[i][1] * fArgs[1] + iau06arr.a0xi[i][2] * fArgs[2] + iau06arr.a0xi[i][3] * fArgs[3] + iau06arr.a0xi[i][4] * fArgs[4] +
//				iau06arr.a0xi[i][5] * fArgs[5] + iau06arr.a0xi[i][6] * fArgs[6] + iau06arr.a0xi[i][7] * fArgs[7] + iau06arr.a0xi[i][8] * fArgs[8] +
//				iau06arr.a0xi[i][9] * fArgs[9] + iau06arr.a0xi[i][10] * fArgs[10] + iau06arr.a0xi[i][11] * fArgs[11] + iau06arr.a0xi[i][12] *
//				fArgs[12] + iau06arr.a0xi[i][13] * fArgs[13];
//			sum1 = sum1 + iau06arr.axs0[i][0] * sin(tempval) + iau06arr.axs0[i][1] * cos(tempval);
//		}
//		sum2 = 0.0;
//		for (j = 35; j >= 0; j--)
//		{
...
//				iau06arr.a0xi[i][9] * fArgs[9] + iau06arr.a0xi[i][10] * fArgs[10] + iau06arr.a0xi[i][11] * fArgs[11] + iau06arr.a0xi[i][12] *
//				fArgs[12] + iau06arr.a0xi[i][13] * fArgs[13];
//			sum2 = sum2 + iau06arr.axs0[i][0] * sin(tempval) + iau06arr.axs0[i][1] * cos(tempval);
//		}
//		sum3 = 0.0;
//		for (j = 3; j >= 0; j--)
//		{
...
//				iau06arr.a0xi[i][9] * fArgs[9] + iau06arr.a0xi[i][10] * fArgs[10] + iau06arr.a0xi[i][11] * fArgs[11] + iau06arr.a0xi[i][12] *
//				fArgs[12] + iau06arr.a0xi[i][13] * fArgs[13];
//			sum3 = sum3 + iau06arr.axs0[i][0] * sin(tempval) + iau06arr.axs0[i][1] * cos(tempval);
//		}
//		sum4 = 0.0;
//		for (j = 0; j >= 0; j--)
//		{
...
//				iau06arr.a0xi[i][9] * fArgs[9] + iau06arr.a0xi[i][10] * fArgs[10] + iau06arr.a0xi[i][11] * fArgs[11] + iau06arr.a0xi[i][12] *
//				fArgs[12] + iau06arr.a0xi[i][13] * fArgs[13];
//			sum4 = sum4 + iau06arr.axs0[i][0] * sin(tempval) + iau06arr.axs0[i][1] * cos(tempval);
//		}
//
...
//		for (i = 961; i >= 0; i--)
//		{
//			tempval = iau06arr.a0yi[i][0] * fArgs[0] + iau06arr.a0yi[i][1] * fArgs[1] + iau06arr.a0yi[i][2] * fArgs[2] + iau06arr.a0yi[i][3] * fArgs[3] + iau06arr.a0yi[i][4] * fArgs[4] +
//				iau06arr.a0yi[i][5] * fArgs[5] + iau06arr.a0yi[i][6] * fArgs[6] + iau06arr.a0yi[i][7] * fArgs[7] + iau06arr.a0yi[i][8] * fArgs[8] +
//				iau06arr.a0yi[i][9] * fArgs[9] + iau06arr.a0yi[i][10] * fArgs[10] + iau06arr.a0yi[i][11] * fArgs[11] + iau06arr.a0yi[i][12] *
//				fArgs[12] + iau06arr.a0yi[i][13] * fArgs[13];
//			sum0 = sum0 + iau06arr.ays0[i][0] * sin(tempval) + iau06arr.ays0[i][1] * cos(tempval);
//		}
//
//		sum1 = 0.0;
//		for (j = 276; j >= 0; j--)
...
//				iau06arr.a0yi[i][9] * fArgs[9] + iau06arr.a0yi[i][10] * fArgs[10] + iau06arr.a0yi[i][11] * fArgs[11] + iau06arr.a0yi[i][12] *
//				fArgs[12] + iau06arr.a0yi[i][13] * fArgs[13];
//			sum1 = sum1 + iau06arr.ays0[i][0] * sin(tempval) + iau06arr.ays0[i][1] * cos(tempval);
//		}
//		sum2 = 0.0;
//		for (j = 29; j >= 0; j--)
//		{
...
//				iau06arr.a0yi[i][9] * fArgs[9] + iau06arr.a0yi[i][10] * fArgs[10] + iau06arr.a0yi[i][11] * fArgs[11] + iau06arr.a0yi[i][12] *
//				fArgs[12] + iau06arr.a0yi[i][13] * fArgs[13];
//			sum2 = sum2 + iau06arr.ays0[i][0] * sin(tempval) + iau06arr.ays0[i][1] * cos(tempval);
//		}
//		sum3 = 0.0;
//		for (j = 4; j >= 0; j--)
//		{
...
//				iau06arr.a0yi[i][9] * fArgs[9] + iau06arr.a0yi[i][10] * fArgs[10] + iau06arr.a0yi[i][11] * fArgs[11] + iau06arr.a0yi[i][12] *
//				fArgs[12] + iau06arr.a0yi[i][13] * fArgs[13];
//			sum3 = sum3 + iau06arr.ays0[i][0] * sin(tempval) + iau06arr.ays0[i][1] * cos(tempval);
//		}
//		sum4 = 0.0;
//		for (j = 0; j >= 0; j--)
//		{
...
//				iau06arr.a0yi[i][9] * fArgs[9] + iau06arr.a0yi[i][10] * fArgs[10] + iau06arr.a0yi[i][11] * fArgs[11] + iau06arr.a0yi[i][12] *
//				fArgs[12] + iau06arr.a0yi[i][13] * fArgs[13];
//			sum4 = sum4 + iau06arr.ays0[i][0] * sin(tempval) + iau06arr.ays0[i][1] * cos(tempval);
//		}
//
...
//		for (i = 32; i >= 0; i--)
//		{
//			tempval = iau06arr.a0si[i][0] * fArgs[0] + iau06arr.a0si[i][1] * fArgs[1] + iau06arr.a0si[i][2] * fArgs[2] + iau06arr.a0si[i][3] * fArgs[3] + iau06arr.a0si[i][4] * fArgs[4] +
//				iau06arr.a0si[i][5] * fArgs[5] + iau06arr.a0si[i][6] * fArgs[6] + iau06arr.a0si[i][7] * fArgs[7] + iau06arr.a0si[i][8] * fArgs[8] +
//				iau06arr.a0si[i][9] * fArgs[9] + iau06arr.a0si[i][10] * fArgs[10] + iau06arr.a0si[i][11] * fArgs[11] + iau06arr.a0si[i][12] *
//				fArgs[12] + iau06arr.a0si[i][13] * fArgs[13];
//			sum0 = sum0 + iau06arr.ass0[i][0] * sin(tempval) + iau06arr.ass0[i][1] * cos(tempval);
//		}
//		sum1 = 0.0;
//		for (j = 2; j >= 0; j--)
//		{
...
//				iau06arr.a0si[i][9] * fArgs[9] + iau06arr.a0si[i][10] * fArgs[10] + iau06arr.a0si[i][11] * fArgs[11] + iau06arr.a0si[i][12] *
//				fArgs[12] + iau06arr.a0si[i][13] * fArgs[13];
//			sum1 = sum1 + iau06arr.ass0[i][0] * sin(tempval) + iau06arr.ass0[i][1] * cos(tempval);
//		}
//		sum2 = 0.0;
//		for (j = 24; j >= 0; j--)
//		{
...
//				iau06arr.a0si[i][9] * fArgs[9] + iau06arr.a0si[i][10] * fArgs[10] + iau06arr.a0si[i][11] * fArgs[11] + iau06arr.a0si[i][12] *
//				fArgs[12] + iau06arr.a0si[i][13] * fArgs[13];
//			sum2 = sum2 + iau06arr.ass0[i][0] * sin(tempval) + iau06arr.ass0[i][1] * cos(tempval);
//		}
//		sum3 = 0.0;
//		for (j = 3; j >= 0; j--)
//		{
...
//				iau06arr.a0si[i][9] * fArgs[9] + iau06arr.a0si[i][10] * fArgs[10] + iau06arr.a0si[i][11] * fArgs[11] + iau06arr.a0si[i][12] *
//				fArgs[12] + iau06arr.a0si[i][13] * fArgs[13];
//			sum3 = sum3 + iau06arr.ass0[i][0] * sin(tempval) + iau06arr.ass0[i][1] * cos(tempval);
//		}
//		sum4 = 0.0;
//		for (j = 0; j >= 0; j--)
//		{
...
//				iau06arr.a0si[i][9] * fArgs[9] + iau06arr.a0si[i][10] * fArgs[10] + iau06arr.a0si[i][11] * fArgs[11] + iau06arr.a0si[i][12] *
//				fArgs[12] + iau06arr.a0si[i][13] * fArgs[13];
//			sum4 = sum4 + iau06arr.ass0[i][0] * sin(tempval) + iau06arr.ass0[i][1] * cos(tempval);
//		}
//
//		s = 0.000094 + 0.00380865 * ttt - 0.00012268 * ttt2
//			- 0.07257411 * ttt3 + 0.00002798 * ttt4 + 0.00001562 * ttt5;   // "
//		//            + 0.00000171*ttt* sin(fArgs[4]) + 0.00000357*ttt* cos(2.0*fArgs[4])  
//		//            + 0.00074353*ttt2* sin(fArgs[4]) + 0.00005691*ttt2* sin(2.0*(fArgs[2]-fArgs[3]+fArgs[4]))  
//		//            + 0.00000984*ttt2* sin(2.0*(fArgs[2]+fArgs[4])) - 0.00000885*ttt2* sin(2.0*fArgs[4]);
...
//		*
//		*  outputs       :
//		*    nut         - transformation matrix for ire-eci
//		*    x           - coordinate of cip                                rad
//		*    y           - coordinate of cip                                rad
//		*    s           - coordinate                                       rad
//		*
...
//		// ---------------- find xys
//		//if (interp ~= 'x')
//		iau06xysS(ttt, iau06arr, fArgs, x, y, s);
//		//else
...
//		iau06data &iau06arr, double fArgs[14],
//		double x, double y, double s,
//		std::vector< std::vector<double> > &nut
//	)
//	{
...
//*  inputs          description                                 range / units
//*    ttt         - julian centuries of tt
//*    opt         - method option                               e80, e96, e00a, e00b, e06cio
//*
//*  outputs       :
...
//*    prec        - matrix converting from "mod" to eci
//*
//*  locals        :
...
//	(
//		double ttt, double ddpsi, double ddeps,
//		const iau06data &iau06arr, eOpt opt, double fArgs[13],
...
//		double deltapsi, deltaeps, pnsum, ensum, pplnsum, eplnsum, oblo, psia, wa, epsa, chia;
//
...
//			for (i = 1357; i >= 0; i--)
//			{
//				tempval = iau06arr.apni[i][0] * fArgs[0] + iau06arr.apni[i][1] * fArgs[1] + iau06arr.apni[i][2] * fArgs[2] + iau06arr.apni[i][3] * fArgs[3] + iau06arr.apni[i][4] * fArgs[4] +
//					iau06arr.apni[i][5] * fArgs[5] + iau06arr.apni[i][6] * fArgs[6] + iau06arr.apni[i][7] * fArgs[7] + iau06arr.apni[i][8] * fArgs[8] +
//					iau06arr.apni[i][9] * fArgs[9] + iau06arr.apni[i][10] * fArgs[10] + iau06arr.apni[i][11] * fArgs[11] + iau06arr.apni[i][12] * fArgs[12] + iau06arr.apni[i][13] * fArgs[13];
//				if (i > 1319)
//					pnsum = pnsum + (iau06arr.apn[i][0] * sin(tempval) + iau06arr.apn[i][1] * cos(tempval)) * ttt;  //note that sin and cos are reveresed between n and e
//				else
//					pnsum = pnsum + iau06arr.apn[i][0] * sin(tempval) + iau06arr.apn[i][1] * cos(tempval);
//			}
//
//			ensum = 0.0;
...
//			for (i = 1055; i >= 0; i--)
//			{
//				tempval = iau06arr.apei[i][0] * fArgs[0] + iau06arr.apei[i][1] * fArgs[1] + iau06arr.apei[i][2] * fArgs[2] + iau06arr.apei[i][3] * fArgs[3] + iau06arr.apei[i][4] * fArgs[4] +
//					iau06arr.apei[i][5] * fArgs[5] + iau06arr.apei[i][6] * fArgs[6] + iau06arr.apei[i][7] * fArgs[7] + iau06arr.apei[i][8] * fArgs[8] +
//					iau06arr.apei[i][9] * fArgs[9] + iau06arr.apei[i][10] * fArgs[10] + iau06arr.apei[i][11] * fArgs[11] + iau06arr.apei[i][12] * fArgs[12] + iau06arr.apei[i][13] * fArgs[13];
//				if (i > 1036)
//					ensum = ensum + (iau06arr.ape[i][0] * cos(tempval) + iau06arr.ape[i][1] * sin(tempval)) * ttt;
//				else
//					ensum = ensum + iau06arr.ape[i][0] * cos(tempval) + iau06arr.ape[i][1] * sin(tempval);
//			}
...
//			for (i = 677; i >= 0; i--)
//			{
//				tempval = iau06arr.appni[i][0] * fArgs[0] + iau06arr.appni[i][1] * fArgs[1] + iau06arr.appni[i][2] * fArgs[2] + iau06arr.appni[i][3] * fArgs[3] + iau06arr.appni[i][4] * fArgs[4];
//				// rad
...
//				pnsum = pnsum + (iau06arr.appn[i][0] + iau06arr.appn[i][1] * ttt) * sin(tempval)
//					+ (iau06arr.appn[i][4]) * cos(tempval);
//				ensum = ensum + (iau06arr.appn[i][2] + iau06arr.appn[i][3] * ttt) * cos(tempval)
//					+ (iau06arr.appn[i][6]) * sin(tempval);
//			}
//
//			pplnsum = 0.0;
//			eplnsum = 0.0;
...
//			for (i = 686; i >= 0; i--)
//			{
//				tempval = iau06arr.aplni[i][0] * fArgs[0] + iau06arr.aplni[i][1] * fArgs[1] + iau06arr.aplni[i][2] * fArgs[2] + iau06arr.aplni[i][3] * fArgs[3] + iau06arr.aplni[i][4] * fArgs[4] +
//					iau06arr.aplni[i][5] * fArgs[5] + iau06arr.aplni[i][6] * fArgs[6] + iau06arr.aplni[i][7] * fArgs[7] + iau06arr.aplni[i][8] * fArgs[8] +
//					iau06arr.aplni[i][9] * fArgs[9] + iau06arr.aplni[i][10] * fArgs[10] + iau06arr.aplni[i][11] * fArgs[11] + iau06arr.aplni[i][12] * fArgs[12] + iau06arr.aplni[i][13] * fArgs[13];
//				pplnsum = pplnsum + iau06arr.apln[i][0] * sin(tempval) + iau06arr.apln[i][1] * cos(tempval);
//				eplnsum = eplnsum + iau06arr.apln[i][2] * sin(tempval) + iau06arr.apln[i][3] * cos(tempval);
//			}
//
//			//  add planetary and luni-solar components.
...
//			{
//				ast = gmst + deltapsi * cos(meaneps) + 0.00264 * pi / (3600 * 180) * sin(fArgs[4])
//					+ 0.000063 * pi / (3600 * 180) * sin(2.0 * fArgs[4]);
//			}
//			else
...
//	}  // procedure sidereal
        ...
        *    opt         - method option                           e80, e96, e00a, e06cio
        *
        *  outputs       :
	...
	void polarm
	(
		double xp, double yp, double ttt, eOpt opt, mat3x3 pm
	)
	{
		//pm.resize(3);  // rows
...
//        *    the eci mean equator mean equinox (eci).
//        *
...
//			it->resize(3);
//		// locals
//		double psia, wa, epsa, chia, deltapsi, deltaeps, x, y, s,
//			trueeps, meaneps, fArgs[14], omegaearth[3], omgxr[3], omgxomgxr[3],
...
//		deg2rad = pi / 180.0;
//
//		double ttt = (jdtt + jdftt - 2451545.0) / 36525.0;
//
//		fundarg(ttt, opt, fArgs);
//
//        // IAU-76/FK5 approach
//		if (opt == e80 || opt == e96)
//		{
//			precess(ttt, opt, psia, wa, epsa, chia, prec);
//			nutation(ttt, ddpsi, ddeps, iau80arr, opt, fArgs, deltapsi, deltaeps, trueeps, meaneps, nut);
//			sidereal(jdut1, deltapsi, meaneps, fArgs, lod, 2, opt, st, stdot);
//		}
//		else
...
//				prec[1][1] = 1.0;
//				prec[2][2] = 1.0;
//				iau06xys(jdtt, ttt, ddx, ddy, 'x', iau06arr, fArgs, jdxysstart, x, y, s, nut);
//				sidereal(jdut1, 0.0, 0.0, fArgs, lod, 2, opt, st, stdot);
...
//			thetasa, omegaearth[3], rpef[3], vpef[3], apef[3], omgxr[3], omgxomgxr[3],
//			omgxv[3], tempvec1[3], tempvec[3], fArgs[14];
//
//		fundarg(ttt, opt, fArgs);
//
//		// ---- find matrices
//		precess(ttt, opt, psia, wa, epsa, chia, prec);
//		nutation(ttt, 0.0, 0.0, iau80arr, opt, fArgs, deltapsi, deltaeps, trueeps, meaneps, nut);
//		sidereal(jdut1, deltapsi, meaneps, fArgs, lod, eqeterms, opt, st, stdot);
//		polarm(xp, yp, ttt, opt, pm);
//
//		// ---- perform transformations
//		thetasa = earthrot * (1.0 - lod / 86400.0);
...
//         *                           function eci_pef
//         *
//         *  this function transforms between the eci mean equator mean equinox (eci), and
...
//		double ttt, x, y, s, psia, wa, epsa, chia, deltapsi, deltaeps, trueeps, meaneps,
//			fArgs[14], omegaearth[3], omgxr[3], omgxomgxr[3],
...
//			MathTimeLib::matvecmult(tempmat, reci, rpef);
//
//			MathTimeLib::cross(omegaearth, rpef, omgxr);
//			MathTimeLib::matvecmult(tempmat, veci, tempvec1);
//			MathTimeLib::addvec(1.0, tempvec1, -1.0, omgxr, vpef);
//
//			MathTimeLib::addvec(1.0, tempvec1, -1.0, omgxr, vpef);
//			MathTimeLib::cross(omegaearth, vpef, omgxv);
//			MathTimeLib::cross(omegaearth, omgxr, omgxomgxr);
//			MathTimeLib::matvecmult(tempmat, aeci, tempvec1);
//			MathTimeLib::addvec(1.0, tempvec1, -1.0, omgxomgxr, tempvec);
//			MathTimeLib::addvec(1.0, tempvec, -2.0, omgxv, apef);
//		}
//		else
...
//			MathTimeLib::matvecmult(tempmat, rpef, reci);
//
//			MathTimeLib::cross(omegaearth, rpef, omgxr);
//			MathTimeLib::addvec(1.0, vpef, 1.0, omgxr, tempvec1);
//			MathTimeLib::matvecmult(tempmat, tempvec1, veci);
//
//			MathTimeLib::cross(omegaearth, omgxr, omgxomgxr);
//			MathTimeLib::cross(omegaearth, vpef, omgxv);
//			MathTimeLib::addvec(1.0, apef, 1.0, omgxomgxr, tempvec);
//			MathTimeLib::addvec(1.0, tempvec, 2.0, omgxv, tempvec1);
//			MathTimeLib::matvecmult(tempmat, tempvec1, aeci);
//		}
//	}  // procedure eci_pef
//
//        /* ----------------------------------------------------------------------------
...
//		double ttt, x, y, s, psia, wa, epsa, chia, deltapsi, deltaeps, trueeps, meaneps, fArgs[14];
//
//		ttt = (jdtt + jdftt - 2451545.0) / 36525.0;
//
//		fundarg(ttt, opt, fArgs);
...
//
//			MathTimeLib::matvecmult(tempmat, reci, rtod);
//			MathTimeLib::matvecmult(tempmat, veci, vtod);
//			MathTimeLib::matvecmult(tempmat, aeci, atod);
//		}
//		else
//		{
//
//			MathTimeLib::matmult(prec, nut, tempmat, 3, 3, 3);
//			MathTimeLib::matvecmult(tempmat, rtod, reci);
//			MathTimeLib::matvecmult(tempmat, vtod, veci);
//			MathTimeLib::matvecmult(tempmat, atod, aeci);
//		}
//        }  //  eci_tod 
//
//        /* ----------------------------------------------------------------------------
...
//			MathTimeLib::mattrans(prec, precp, 3, 3);
//
//			MathTimeLib::matvecmult(precp, reci, rmod);
//			MathTimeLib::matvecmult(precp, veci, vmod);
//			MathTimeLib::matvecmult(precp, aeci, amod);
//		}
//		else
//		{
//			MathTimeLib::matvecmult(prec, rmod, reci);
//			MathTimeLib::matvecmult(prec, vmod, veci);
//			MathTimeLib::matvecmult(prec, amod, aeci);
//		}
//        }  //  eci_mod 
//
//
...
//		std::vector< std::vector<double> > temp = std::vector< std::vector<double> >(3, std::vector<double>(3));
//		std::vector< std::vector<double> > tempmat = std::vector< std::vector<double> >(3, std::vector<double>(3));
//		double deltapsi, deltaeps, trueeps, meaneps, fArgs[14], omegaearth[3],
...
//		std::vector< std::vector<double> > temp = std::vector< std::vector<double> >(3, std::vector<double>(3));
//		std::vector< std::vector<double> > tempmat = std::vector< std::vector<double> >(3, std::vector<double>(3));
//		double deltapsi, deltaeps, trueeps, meaneps, fArgs[4], thetasa, omegaearth[3],
//			rpef[3], vpef[3], apef[3], omgxr[3], omgxomgxr[3],
//			omgxv[3], tempvec1[3], tempvec[3];
//
//		// ---- find matrices
...
//	} // procedure ecef_pef
	...
	)
	{
		...
		mat3x3 st, stdot, temp, tempmat, pm, pmp, stp;
		...
		raan = fmod(raan, 360.0) * deg2rad;

		// ------------------------find gmst--------------------------
		gmst = gstime_SGP4(jdut1);
		...
		{
			gmstg = gmst
				+ 0.00264 * conv * sin(raan)
				+ 0.000063 * conv * sin(2.0 * raan);
		}
		else
			gmstg = gmst;
...
// Can probably remove the unused branch...
		if (direct == eTo)
		{
			mattrans(pm, pmp, 3, 3);
			mattrans(st, stp, 3, 3);

			matvecmult(stp, rteme, rpef);
			matvecmult(pmp, rpef, recef);

			cross(omegaearth, rpef, omgxr);
			matvecmult(stp, vteme, tempvec1);
			addvec(1.0, tempvec1, -1.0, omgxr, vpef);
			matvecmult(pmp, vpef, vecef);

			addvec(1.0, tempvec1, -1.0, omgxr, vpef);
			cross(omegaearth, vpef, omgxv);
			cross(omegaearth, omgxr, omgxomgxr);
			matvecmult(stp, ateme, tempvec1);
			addvec(1.0, tempvec1, -1.0, omgxomgxr, tempvec);
			addvec(1.0, tempvec, -2.0, omgxv, apef);
			matvecmult(pmp, apef, aecef);
		}
		else
		{
			matvecmult(pm, recef, rpef);
			matvecmult(st, rpef, rteme);

			matvecmult(pm, vecef, vpef);
			cross(omegaearth, rpef, omgxr);
			addvec(1.0, vpef, 1.0, omgxr, tempvec1);
			matvecmult(st, tempvec1, vteme);

			matvecmult(pm, aecef, apef);
			cross(omegaearth, omgxr, omgxomgxr);
			cross(omegaearth, vpef, omgxv);
			addvec(1.0, apef, 1.0, omgxomgxr, tempvec);
			addvec(1.0, tempvec, 2.0, omgxv, tempvec1);
			matvecmult(st, tempvec1, ateme);
		}
...
//		double psia, wa, epsa, chia, deltapsi, deltaeps, trueeps, meaneps, fArgs[14], eqeg;
//
//		fundarg(ttt, opt, fArgs);
//
//		precess(ttt, e80, psia, wa, epsa, chia, prec);
...
//
//			MathTimeLib::matvecmult(tempmat, rteme, reci);
//			MathTimeLib::matvecmult(tempmat, vteme, veci);
//			MathTimeLib::matvecmult(tempmat, ateme, aeci);
//		}
//		else
//		{
//			MathTimeLib::mattrans(nut, nutp, 3, 3);
...
//
//			MathTimeLib::matvecmult(tempmat, reci, rteme);
//			MathTimeLib::matvecmult(tempmat, veci, vteme);
//			MathTimeLib::matvecmult(tempmat, aeci, ateme);
//		}
//
//	}  //  teme_eci
//
	...
	)
	{
		...
		*latgd = decl;
		...
		while ((fabs(olddelta - (*latgd)) >= small) && (i < 10))
		{
			olddelta = (*latgd);
			sintemp = sin(*latgd);
            const double re = 6378.1363;              // km  stk uses .1363
...
//	)
//	{
//		double a, b, d, e, f, g, p, q, t, rtasc, atemp, temp, third, nu, sqrtp, magr;
//
//		const double small = 0.00000001;         // small value for tolerances
//
//		// -------------------------  implementation   -------------------------
...
//
//		a = 6378.1363;
//		// b = MathTimeLib::sgn(r[2]) * 6356.75160056;
//		b = MathTimeLib::sgn(recef[2]) * a * sqrt(1.0 - 0.006694385);  // find semiminor axis of the earth
//
//		 // -------------- set up initial latitude value  ---------------
//		atemp = 1.0 / (a * temp);
//		e = (b * recef[2] - a * a + b * b) * atemp;
//		f = (b * recef[2] + a * a - b * b) * atemp;
//		third = 1.0 / 3.0;
//		p = 4.0 * third * (e * f + 1.0);
//		q = 2.0 * (e * e - f * f);
//		d = p * p * p + q * q;
//
//		if (d > 0.0)
//			nu = pow((sqrt(d) - q), third) - pow((sqrt(d) + q), third);
//		else
//		{
//			sqrtp = sqrt(-p);
...
//		hellp = (temp - a * t) * cos(latgd) + (recef[2] - b) * sin(latgd);
//
//		latgc = asin(recef[2] / magr);   // all locations
...
//							y = magr1 + magr2;
//						if (show == 'y')
//							printf("%3d %10.5f %10.5f %10.5f %7.3f %9.5f %9.5f  %9.5f\n",
...
//	*
//	*  locals         :
//	*    fArgs[1]           - line of sight vector for 1st
...
//		lmati[1][1] = (l1[0] * l2[2] + l1[2] * l2[0]) / d;
...
//				//      if (fileout != null)
//				//      {
//				//        fprintf(fileout, "root %fArgs[3] %0.7f + %0.7f j  value = %0.7f\n",
...
//	vector fArgs[1](3), l2(3), l3(3), ldot(3), lddot(3), rs2dot(3), rs2ddot(3),
//	earthrate(3), temp(3), temp1(3);
//	double   fArgs[3], d1, d2, d3, d4, rho, rhodot, t1t13, t1t3, t31t3, temproot,
...
//
//	// --------------- find line of sight vectors -------------------
//	fArgs[1][] = (cos(tdecl1) * cos(trtasc1), 1);
//	l2[] = (cos(tdecl1) * sin(trtasc1), 2);
//	l2[] = (sin(tdecl1), 3);
//	fArgs[1][] = (cos(tdecl2) * cos(trtasc2), 1);
//	l2[] = (cos(tdecl2) * sin(trtasc2), 2);
//	l2[] = (sin(tdecl2), 3);
//	fArgs[1][] = (cos(tdecl3) * cos(trtasc3), 1);
...
//	for (uint i = 1; i <= 3; i++)
//	{
//	ldot[] = ((-tau3 * t1t13) * fArgs[1][i) +
//	((-tau1 - tau3) * t1t3) * l2[i) +
//	(-tau1 * t31t3) * l3[i), i);
//	lddot[] = ((2.0 * t1t13) * fArgs[1][i) +
//	(2.0 * t1t3)  * l2[i) +
//	(2.0 * t31t3) * l3[i), i);
//	}
//
...
//	*     repeat
//	*         oldr:= r2[4];
//	*         rho:= -2.0*d1/fArgs[3] - 2.0*d2/(r2[4]*r2[4]*r2[4]*fArgs[3]);
...
//
//
//	if (fabs(fArgs[3]) > 0.000001)
//	{
//	// ---------------- solve eighth order poly -----------------
//	l2dotrs  = l2.dot(rs2);
//	poly[ 0] =  1.0; // r2^8th variable!!!!!!!!!!!!!!
//	poly[ 1] =  0.0;
//	poly[ 2] =  (l2dotrs * 4.0 * d1 / fArgs[3] - 4.0 * d1 * d1 / (fArgs[3] * fArgs[3]) -
//	rs2.MathTimeLib::mag() * rs2.MathTimeLib::mag());
//	poly[ 3] =  0.0;
//	poly[ 4] =  0.0;
//	poly[ 5] =  mu * (l2dotrs * 4.0 * d2 / fArgs[3] - 8.0 * d1 * d2 / (fArgs[3] * fArgs[3]));
//	poly[ 6] =  0.0;
//	poly[ 7] =  0.0;
//	poly[ 8] = -4.0 * mu * d2 * d2 / (fArgs[3] * fArgs[3]);
//	poly[ 9] =  0.0;
//	poly[10] =  0.0;
//	poly[11] =  0.0;
//	poly[12] =  0.0;
...
//	{
//	printf("root %fArgs[3] %f + %f\n", j+1, roots[j][1], roots[j][2]);
//	temproot = roots[j][0] * roots[j][0];
//	temproot = temproot * temproot * temproot * temproot +
//	poly[2]  * temproot * temproot * temproot +
//	poly[5]  * roots[j][0] * temproot + poly[8];
//	if (fileout != null)
//	fprintf(fileout, "root %fArgs[3] %f + %f j  value = %f\n",
//	j, roots[j][0], roots[j][1], temproot);
//	if (roots[j][0] > bigr2)
//	bigr2 = roots[j][0];
//	}
...
//	scanf("%f\n", &bigr2);
//
//	rho = -2.0 * d1 / fArgs[3] - 2.0 * mu * d2 / (bigr2 * bigr2 * bigr2 * fArgs[3]);
//
...
//	rhodot = -d3 / fArgs[3] - mu * d4 / (r2.MathTimeLib::mag() * r2.MathTimeLib::mag() * r2.MathTimeLib::mag() * fArgs[3]);
//	if (fileout != null)
//	{
...
//	fprintf(fileout, "fArgs[3] 01234 = %12.6f %12.6f %12.6f %12.6f %12.6f\n",
//	fArgs[3], d1, d2, d3, d4);
//	//  }
//	dmat.display(" fArgs[3] matrix ", 6);
...
//
//		/* ----------------------------------------------------------------
//		*  determine if the orbit is possible.  both fArgs[3] and n must be in
...
//		fprintf(fileout, "%16s %9.3f %9.3f %9.3f\n",
//		"fArgs[3] vector = ", fArgs[3][1], fArgs[3][2], fArgs[3][3]);
//		fprintf(fileout, "%16s %9.3f %9.3f %9.3f\n",
...
//		tbi = 0.0;
//
//		int err = fopen_s(&outfile, "fArgs[3]:/Codes/LIBRARY/CPP/Libraries/ast2Body/test2body.out", "w");
//
