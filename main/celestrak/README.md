...
These appear to be derived from the functions in the ZIP file linked to from https://celestrak.org/publications/AIAA/2006-6753/.  On the page https://celestrak.org/publications/AIAA/2006-6753/faq.php the license is given as:
...
Earlier work can be seen in https://celestrak.org/NORAD/documentation/spacetrk.pdf with FORTRAN routines by Dr T.S. Kelso (https://celestrak.org/webmaster.php).
