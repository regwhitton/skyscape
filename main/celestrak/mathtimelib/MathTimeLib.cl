...
* --------------------------------------------------------------------------- */
	...
	void    mattrans
	(
		mat3x3 mat1, //std::vector< std::vector<double> > mat1,
		mat3x3 mat2, //std::vector< std::vector<double> > &mat2,
		//          double mat1[3][3],
		//          double mat2[3][3],
		int mat1r, int mat1c
	)
...
//
	...
	* --------------------------------------------------------------------------- */
	...
	)
	{
		...
		// ------------------------  implementation   ------------------
		jday_SGP4(year, mon, day, 0, 0, 0.0, &jd, &jdFrac);
		//     mjd  = jd - 2400000.5;
		...
		jday_SGP4(year, mon, day, hrtemp, mintemp, sectemp, jdut1, jdut1Frac);
		...
		jday_SGP4(year, mon, day, hrtemp, mintemp, sectemp, jdtt, jdttFrac);
		...
		jday_SGP4(year, mon, day, hrtemp, mintemp, sectemp, jdtdb, jdtdbFrac);
