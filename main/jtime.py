...
def build_jtime_dtype():
    ...
    return np.dtype(
        [
            (JULIAN_DATE, cltypes.double),
            (JULIAN_FRACTION_INTO_DAY, cltypes.double),
            (JULIAN_DATE_UT1, cltypes.double),
            (JULIAN_DATE_UT1_FRACTION_INTO_DAY, cltypes.double),
            (JULIAN_CENTRURIES_OF_DYNAMIC_TIME, cltypes.double),
        ]
    )
